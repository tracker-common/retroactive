  	...
  	render() {
	  	if(this.props.token){
	    	...
	    	<div className="dashboard-form" > 
				...
				<br/>
				<form>
					<label>Tracker API Token: </label><input type="text" ref="tokenText" value=""/>
					<button type="button" onClick={this.props.handleSaveToken(this.refs.tokenText.value)}>Save</button>
				</form>
			</div>
			);
	  	}
